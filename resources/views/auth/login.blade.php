...
<head>
    ...
    <title>{{ \App\Models\AppSetting::getAppName() }} - Login</title>
    <meta name="description" content="Login to {{ \App\Models\AppSetting::getAppName() }} - AI-Based Stock Analysis & Prediction System">
    ...
    <div class="min-h-screen pt-24 pb-12 px-4  flex items-center justify-center">
        <div class="w-full max-w-md">
            ...
            <div class="mb-8 text-center">
                ...
                <p class="text-slate-600 dark:text-slate-400">Sign in to your ArthaPredict account to access stock
            ...
            <div
                ...
                @if (session('status'))
                    <div
                        ...
                        <p class="text-sm font-semibold text-blue-700 dark:text-blue-400">{{ session('status') }}</p>
                    </div>
                @endif
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div class="flex items-center">
                        <input id="remember_me" type="checkbox" name="remember"
                            class="w-4 h-4 rounded border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-500 focus:ring-blue-500 dark:focus:ring-blue-400 cursor-pointer">
                ...
                <div class="relative my-6">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400">Don&apos;t have
                            an account?</span>
                    </div>
                </div>
                ...
                <a href="{{ route('register') }}"
                    class="w-full block text-center px-6 py-3 rounded-lg border-2 border-blue-600 dark:border-blue-500
