...
<head>
    ...
    <title>{{ \App\Models\AppSetting::getAppName() }} - Forgot Password</title>
    <meta name="description" content="Reset your password - {{ \App\Models\AppSetting::getAppName() }} AI-Based Stock Analysis & Prediction System">
    ...
    <div class="min-h-screen pt-24 pb-12 px-4 flex items-center justify-center">
        <div class="w-full max-w-md">
            ...
            <div class="mb-8 text-center">
                <h1 class="text-4xl font-bold mb-2">Reset Your Password</h1>
                <p class="text-slate-600 dark:text-slate-400">Enter your email address and we'll send you a password reset link</p>
            </div>
            ...
            <div
                ...
                @if (session('status'))
                    <div
                        ...
                        <p class="text-sm font-semibold text-green-700 dark:text-green-400">{{ session('status') }}</p>
                    </div>
                @endif
