    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full whitespace-nowrap">
                <thead>
                    <tr
                        class="text-left bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-700 text-xs uppercase tracking-wider text-gray-500 dark:text-gray-300 font-semibold">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                    @forelse($stocks as $stock)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="px-2 py-1 text-xs rounded-md bg-gray-100 text-gray-600 dark:bg-gray-600 dark:text-gray-300">
                                    {{ $stock->exchange ?? 'N/A' }}
                                </span>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('stocks.show', $stock->symbol) }}"
                                    class="inline-flex items-center justify-center px-4 py-1.5 bg-blue-50 text-blue-600 hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-400 dark:hover:bg-blue-900/50 rounded-lg text-sm font-medium transition">
                                    View Details
                                </a>
                            </td>
                        </tr>
